...
public class HomeController implements Initializable{
   ...
   //TO CHANGE 
    ...
    void sport(ActionEvent event) throws IOException  {
    	...
    	if (HomeModel.getConsulteRubrique(2, idfDate)== null) //c'est la premiere fois de la journÈe qu'il conuslte la rubrique
    	{
    ...
    void relaxion(ActionEvent event) throws IOException {
    	...
    	if (HomeModel.getConsulteRubrique(3, idfDate) == null)//c'est la premiere fois de la journÈe qu'il conuslte la rubrique
    	{
    ...
    void temoignage(ActionEvent event) throws IOException {
    	...
    	//augementer le nbr de coins etant donne qu'il a conulte  la rubrique
    	if (HomeModel.getConsulteRubrique(4, idfDate)== null) //c'est la premiere fois de la journÈe qu'il conuslte la rubrique
    	{
    ...
    void dev(ActionEvent event) throws IOException {
    	...
    	//augementer le nbr de coins etant donne qu'il a conulte  la rubrique
    	if (HomeModel.getConsulteRubrique(5, idfDate)== null) //c'est la premiere fois de la journÈe qu'il conuslte la rubrique
    	{
    ...
    void ed(ActionEvent event) throws IOException {
    	...
    	//augementer le nbr de coins etant donne qu'il a conulte  la rubrique
    	if (HomeModel.getConsulteRubrique(1, idfDate)== null) //c'est la premiere fois de la journÈe qu'il conuslte la rubrique
    	{
    ...
    void pp(ActionEvent event) throws IOException {
    	...
    	//augementer le nbr de coins etant donne qu'il a conulte  la rubrique
    	if (HomeModel.getConsulteRubrique(7, idfDate)== null) //c'est la premiere fois de la journÈe qu'il conuslte la rubrique
    	{
    ...
    void appris(ActionEvent event) throws IOException {
    	...
    	//augementer le nbr de coins etant donne qu'il a conulte  la rubrique
    	if (HomeModel.getConsulteRubrique(6, idfDate)== null) //c'est la premiere fois de la journÈe qu'il conuslte la rubrique
    	{
